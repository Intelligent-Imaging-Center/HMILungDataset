...
# ----------------------------------------------------------------------设置--------------------------------------------------------------
input_dir = "../lin1and3"
# input_file = "../check.hdr"
output_dir = input_dir
# Input dir and output dir should be the same in most circustances
per_band_value_tolerance = 20 
per_band_number_tolerance = 20
total_band_value_tolerance = 1000
...
for input_file in fileList:
    ...
    cv2.imwrite(output_dir + "/" + get_base_name(output_file) + ".jpeg", img)
    print("Save output image ", output_dir + "/" + get_base_name(output_file) + ".jpeg" )
