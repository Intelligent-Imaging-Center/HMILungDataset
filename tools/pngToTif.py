...
source_dir = "../../Training5/Result/GeneratedLabel/lin1-round1/Hybrid_BN_A/output"
target_dir = "../../Training5/Result/GeneratedLabel/lin1-round1/Hybrid_BN_A/output"
...
for f in file_list:
    ...
    output_tif[png_img[:,:,0]!=0] = 1
    output_tif[png_img[:,:,1]!=0] = 2
